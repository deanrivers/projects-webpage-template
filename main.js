$( document ).ready(function() {
  ...
  //add class to button when div is hovered
  $('.demo-container-children').hover(function(){
    var x = $(this).find('button')
    x.addClass('button-div-hover')
  },function(){
    var y = $(this).find('button')
    y.removeClass('button-div-hover')
  })
});
